    ...
    public partial class frmWebBrowser : Form
    {
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            ...
            if (direccion != null)
            {
                ...
                dw.progreso += new Descargador.Progress(this.ProgresoDescarga);
                dw.descargaCompleta += new Descargador.DownloadComplete(this.FinDescarga);

                Thread h = new Thread(dw.IniciarDescarga);
                h.Start();
        ...
        private void btnIr_Click_2(object sender, EventArgs e)
        {
            Uri direccion;
